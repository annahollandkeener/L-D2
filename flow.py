...
def avgDailyFlow(): 
    ...
    #Data definition
    plt.plot(df[dayColumn], df[flowColumn], color=var, zorder = 2, marker = 'o', markerfacecolor = 'black', markeredgecolor = "white", linestyle = '-')
...
def allInstDur():
    ...
    for r in ranges:
        ...
        for tup in tupleLists[tupleListName]:
            if len(tupleLists[tupleListName]) > 0:
                tuplesBool = True
